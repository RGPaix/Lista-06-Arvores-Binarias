...
public class Main_Ex04 {
    public static void main(String[] args) {
        ...
        System.out.println("Soma total dos valores: " + bst.somaTotal());
        System.out.println("Soma dos nós folha: " + bst.somaFolhas());
        System.out.println("Diferença entre soma das subárvores: " + bst.diferencaEntreSubarvores());
